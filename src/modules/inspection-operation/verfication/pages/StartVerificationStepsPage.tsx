...
import StartInspectionStep2 from '@/modules/inspection-operation/verfication/components/StartInspectionStep2.tsx';
        ...
        <Grid container spacing={2}>
          <Grid size={{ xs: 10.5 }} >
            <Typography fontWeight={700} variant="h5" marginBottom={'50px'}>
              پیکربندی بازرسی راستی آزمایی {data?.organizationUnitName}
            </Typography>
          </Grid>
          <Grid size={{ xs: 1.5 }} >
            <BackButton />
