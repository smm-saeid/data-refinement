...
export default function MilitaryKnowledgeScoresForm() {
  const { id } = useParams();
        ...
        <Grid container spacing={2}>
          <Grid size={{ xs: 8 }}>
            <Typography fontWeight={700} variant="h5">
              دانش نظامی برای بازرسی {inspection?.organizationUnitName} -{' '}
      ...
      <Box sx={{ width: '100%' }}>
        <Paper elevation={2} sx={{ padding: '5px' }}>
          <PaginatedMatnaDataGrid
            url={'/military-knowledge/find-by-parameter'}
        ...
        <Fragment>
          <Dialog maxWidth={'md'} open={isOpen} onClose={handleClose}>
            <Grid container spacing={2} padding={'20px'}>
              <Grid size={{ xs: 12 }}>
                <Typography>
                  برای افزودن نمره دانش نظامی، فیلد های موجود را وارد کنید.
                </Typography>
              </Grid>
